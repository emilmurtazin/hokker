...
def send_message_strict(chat_id: str, text: str) -> None:
    """
    ...
    if not settings.TELEGRAM_BOT_TOKEN:
        ...
        return
    _call("sendMessage", {"chat_id": chat_id, "text": _fit(text), "parse_mode": "HTML"})
...
def send_message(chat_id: str, text: str) -> bool:
    ...
    """
    try:
        send_message_strict(chat_id, text)
        return True
...
def send_message_or_http_error(chat_id: str, text: str) -> None:
    """
